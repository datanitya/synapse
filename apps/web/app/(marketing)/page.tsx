...
const PLANS = [
  {
    ...
    price: '₹0',
    period: '',
    features: ['Trends feed', '~10 posts per month', 'Drafts & content bank', 'LinkedIn login'],
  ...
  },
  {
    ...
    price: '₹999',
    period: '/month',
    features: ['Everything in Creator', 'Image generation', 'Advanced filters', 'Priority support'],
    cta: 'Join Beta',
    href: '#waitlist',
    highlight: false,
  },
